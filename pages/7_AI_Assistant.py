...
# Extra blank space aur white gap hatane ke liye
st.markdown("""
    <style>
    /* Message box ki extra height aur space reduce karein */
    .stChatMessage {
    ...
    /* Text ke andar ki blank lines aur bottom margins ko fix karein */
